...
- The **tidyverse** is a collection of R packages which share a design philosophy, syntax, and data structures in which tidyr is one of them. One of the powerful function in the tidyverse is the pipes (%>%).
